...
const styles = StyleSheet.create({
  ...
  addModeBannerText: { color: colors.primaryContainer, fontSize: 11, fontWeight: '700', letterSpacing: 0.5 },
  ...
  backBtn:     { width: 40, height: 40, borderRadius: 12, backgroundColor: colors.surfaceContainer, alignItems: 'center', justifyContent: 'center' },
  backBtnText: { fontSize: 24, color: colors.onSurface, lineHeight: 28 },
  headerText:  { flex: 1 },
  pageTitle:   { fontSize: 26, fontWeight: '900', color: colors.onSurface, letterSpacing: -0.5 },
  pageSubtitle:{ fontSize: 9,  fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 3 },
  countBadge:  { backgroundColor: colors.primaryContainer, borderRadius: 50, paddingHorizontal: 12, paddingVertical: 6 },
  countText:   { color: colors.onPrimaryContainer, fontWeight: '900', fontSize: 13 },
  addExerciseBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: colors.primaryContainer, alignItems: 'center', justifyContent: 'center' },
  addExerciseBtnText: { fontSize: 22, color: colors.onPrimaryContainer, fontWeight: '900', lineHeight: 26 },

  // Controls
  controls:  { paddingHorizontal: 20, marginBottom: 12, gap: 10 },
  searchBar: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: colors.surfaceContainer,
    borderRadius: 50, paddingHorizontal: 16, paddingVertical: 10, gap: 10,
  },
  searchIcon:  { fontSize: 14, color: colors.onSurfaceVariant },
  searchInput: { flex: 1, color: colors.onSurface, fontSize: 13 } as any,
  ...
  filterChipText:      { fontSize: 9, fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 1.5 },
  ...
  statNum:   { fontSize: 24, fontWeight: '900', color: colors.primaryContainer },
  statLabel: { fontSize: 8, fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 2, marginTop: 4 },

  equipRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 28 },
  equipIcon:{ fontSize: 18, color: colors.onSurfaceVariant },
  equipText:{ fontSize: 11, fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 2 },
  ...
  addBtnText: { color: colors.onPrimaryContainer, fontWeight: '900', fontSize: 12, letterSpacing: 2 },

  closeBtn:     { paddingVertical: 14, alignItems: 'center' },
  closeBtnText: { color: colors.onSurfaceVariant, fontSize: 11, fontWeight: '700', letterSpacing: 1.5 },

  // Create exercise form
  createTitle:  { fontSize: 26, fontWeight: '900', color: colors.onSurface, letterSpacing: -0.5, marginBottom: 4 },
  createMuscle: { fontSize: 9, fontWeight: '700', color: colors.primaryContainer, letterSpacing: 3, marginBottom: 24 },
  fieldLabel:   { fontSize: 9, fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 2, marginBottom: 6, marginTop: 14 },
  fieldInput:   {
    backgroundColor: colors.surfaceContainerHighest,
    borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12,
    color: colors.onSurface, fontSize: 14,
  } as any,
  fieldInputMulti: { minHeight: 60, textAlignVertical: 'top' } as any,
  optionRow:    { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  optionChip:   { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 50, backgroundColor: colors.surfaceContainerHighest },
  optionChipActive:    { backgroundColor: colors.primaryContainer },
  optionChipText:      { fontSize: 9, fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 1 },
