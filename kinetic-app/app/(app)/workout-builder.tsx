...
const s = StyleSheet.create({
  ...
  setsColLblDel: { width: 32, fontSize: fs(7), fontWeight: '700', color: colors.secondary + 'aa', letterSpacing: 1, textAlign: 'center' },
  setNumCol:     { width: 32, alignItems: 'center' },
  ...
  removeSetBtn:  { width: 32, height: 32, borderRadius: 8, backgroundColor: colors.surfaceContainerHigh, alignItems: 'center', justifyContent: 'center' },
  removeSetBtnText: { fontSize: fs(16), color: colors.secondary, lineHeight: 22 },
