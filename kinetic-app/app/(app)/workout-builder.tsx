...
const s = StyleSheet.create({
  ...
  // Template modal
  templateCard: {
    backgroundColor: colors.surfaceContainerHighest, borderRadius: 14, padding: 18,
    marginBottom: 10, flexDirection: 'row', alignItems: 'center',
  },
  templateCardLeft:  { flex: 1, gap: 4 },
  templateCardLabel: { fontSize: fs(13), fontWeight: '900', color: colors.onSurface, letterSpacing: 0.5 },
  templateCardDesc:  { fontSize: fs(11), color: colors.onSurfaceVariant, lineHeight: 18 },
  templateCardDays:  { fontSize: fs(9), color: colors.primaryContainer, fontWeight: '700', letterSpacing: 1, marginTop: 2 },
  templateCardGoal:  { fontSize: fs(8), fontWeight: '800', color: colors.tertiary, letterSpacing: 1 },
  ...
  planTabText:    { fontSize: fs(11), fontWeight: '800', color: colors.onSurfaceVariant, letterSpacing: 0.5 },
  planTabTextActive: { color: colors.onPrimaryContainer },
  planTabGoal:    { fontSize: fs(8), color: colors.outlineVariant, letterSpacing: 1 },
  ...
  renameBadgeText: { fontSize: fs(9), fontWeight: '800', color: colors.primaryContainer, letterSpacing: 1 },
  deletePlanBtn:     { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8, backgroundColor: colors.surfaceContainer },
  deletePlanBtnText: { fontSize: fs(9), color: colors.secondary, fontWeight: '700', letterSpacing: 1 },

  dayTabsScroll: { flexGrow: 0, marginBottom: 10 },
  dayTabs:       { paddingHorizontal: 22, gap: 6 },
  dayTab:        { width: 58, paddingVertical: 12, borderRadius: 12, backgroundColor: colors.surfaceContainer, alignItems: 'center', gap: 4 },
  dayTabActive:  { backgroundColor: colors.surfaceContainerHigh, borderWidth: 1, borderColor: colors.primaryContainer },
  dayTabText:    { fontSize: fs(9), fontWeight: '800', color: colors.onSurfaceVariant, letterSpacing: 1 },
  ...
  exerciseList:    { paddingHorizontal: 22, paddingBottom: 48, gap: 12 },
  addExerciseBtn:  {
  ...
  addExerciseBtnText: { color: colors.primaryContainer, fontSize: fs(10), fontWeight: '800', letterSpacing: 1.5 },
  emptyDay:        { alignItems: 'center', paddingVertical: 40, gap: 10 },
  emptyDayText:    { fontSize: fs(22), fontWeight: '900', color: colors.onSurfaceVariant },
  ...
  cardMuscle: { fontSize: fs(10), color: colors.onSurfaceVariant, letterSpacing: 0.5 },
  removeBtn:  { width: 32, height: 32, borderRadius: 8, backgroundColor: colors.surfaceContainerHigh, alignItems: 'center', justifyContent: 'center' },
  removeBtnText: { fontSize: fs(18), color: colors.secondary, lineHeight: 24 },

  // Inline sets
  setsBlock:     { gap: 6 },
  setsColHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 4, paddingHorizontal: 2 },
  setsColLbl:    { flex: 1, fontSize: fs(8), fontWeight: '800', color: colors.onSurfaceVariant, letterSpacing: 1.5, textAlign: 'center' },
  setsColLblDel: { width: 28, fontSize: fs(7), fontWeight: '700', color: colors.secondary + 'aa', letterSpacing: 1, textAlign: 'center' },
  setNumCol:     { width: 24, alignItems: 'center', flexShrink: 0 },
  setNum:        { fontSize: fs(10), fontWeight: '800', color: colors.onSurfaceVariant },

  setRow:     { flexDirection: 'row', alignItems: 'center', gap: 6 },
  setInput:   {
    flex: 1, minWidth: 0, backgroundColor: colors.surfaceContainerHigh,
  ...
  setX:          { fontSize: fs(16), color: colors.outlineVariant, fontWeight: '400' },
  removeSetBtn:  { width: 28, height: 28, borderRadius: 6, backgroundColor: colors.surfaceContainerHigh, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  removeSetBtnText: { fontSize: fs(14), color: colors.secondary, lineHeight: 20 },

  addSetBtn:     { backgroundColor: colors.surfaceContainerHigh, borderRadius: 10, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: colors.outlineVariant },
  addSetBtnText: { fontSize: fs(9), fontWeight: '800', color: colors.primaryContainer, letterSpacing: 1.5 },
  loadingHint: { fontSize: fs(11), color: colors.onSurfaceVariant, paddingVertical: 8, fontWeight: '600' },

  // Modal
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.75)', justifyContent: 'flex-end' },
  modalSheet:   { backgroundColor: colors.surfaceContainerHigh, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 28, paddingBottom: 48 },
  sheetHandle:  { width: 40, height: 4, borderRadius: 2, backgroundColor: colors.outlineVariant, alignSelf: 'center', marginBottom: 24 },
  modalTitle:   { fontSize: fs(24), fontWeight: '900', color: colors.onSurface, letterSpacing: -0.5, marginBottom: 4 },
  modalSubtitle:{ fontSize: fs(9), color: colors.onSurfaceVariant, letterSpacing: 2, marginBottom: 16 },
  inputLabel:   { fontSize: fs(9), fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 2, marginBottom: 8, marginTop: 16 },
  textInput:    { backgroundColor: colors.surfaceContainerHighest, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 16, color: colors.onSurface, fontSize: fs(15) } as any,

  goalChips:        { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  goalChip:         { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 50, backgroundColor: colors.surfaceContainerHighest },
  goalChipActive:   { backgroundColor: colors.primaryContainer },
  goalChipText:     { fontSize: fs(9), fontWeight: '700', color: colors.onSurfaceVariant, letterSpacing: 1 },
  goalChipTextActive: { color: colors.onPrimaryContainer },

  createBtn:        { backgroundColor: colors.primaryContainer, borderRadius: 50, paddingVertical: 20, alignItems: 'center', marginTop: 28 },
  createBtnText:    { color: colors.onPrimaryContainer, fontWeight: '900', fontSize: fs(12), letterSpacing: 2 },
  cancelBtn:        { paddingVertical: 16, alignItems: 'center' },
  cancelBtnText:    { color: colors.onSurfaceVariant, fontSize: fs(11), fontWeight: '700', letterSpacing: 1.5 },

  emptyStateText:    { color: colors.onSurfaceVariant, fontSize: fs(14), textAlign: 'center', marginBottom: 28 },
  createFirstPlanBtn:{ backgroundColor: colors.primaryContainer, borderRadius: 50, paddingHorizontal: 36, paddingVertical: 16 },
  createFirstPlanText: { color: colors.onPrimaryContainer, fontWeight: '900', fontSize: fs(11), letterSpacing: 1.5 },
});
